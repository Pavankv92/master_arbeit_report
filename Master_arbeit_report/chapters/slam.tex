...
The last step of electrode digitalization is calculating cluster centers. First, the number of clusters is determined by the algorithm DBSCAN. Then, the k-Nearest Neighbor (kNN) algorithm is applied to determine the membership of each electrode in a cluster and to determine the centroid of each cluster as shown in \cref{fig:cluster_and_its_centers}.
