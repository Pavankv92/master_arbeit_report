...
Several libraries has been used to implement each module used for electrode digitalization therefore, we give a brief introduction to various libraries used in the rest of this section.
