...
Let ($k_P$,$\theta_p$) and ($k_q$,$\theta_q$) be axis angle representation \cite{axis-angle} of rotational part $\mathtt{R}[\matr{P}]$ and $\mathtt{R}[\matr{Q}]$ respectively. Then the metric for the rotational part is \cref{eq:rotational_metric}, the axis part is neglected. 
